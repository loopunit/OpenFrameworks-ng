...
if( MSVC )
  ...
  set(ASSIMP_LIBRARY_SUFFIX "3.0-${MSVC_PREFIX}-mt" CACHE STRING "the suffix for the assimp windows library" FORCE)
else()
  set(ASSIMP_LIBRARY_SUFFIX "3.0" CACHE STRING "the suffix for the openrave libraries" FORCE)
endif()
