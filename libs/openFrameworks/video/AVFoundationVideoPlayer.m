...
- (id)init {
    ...
    if(self) {
         ...
         */
        self.playerView = [[[AVFoundationVideoPlayerView alloc] initWithFrame:[NSScreen mainScreen].frame] autorelease];
        //self.playerView.backgroundColor = [NSColor blackColor];
