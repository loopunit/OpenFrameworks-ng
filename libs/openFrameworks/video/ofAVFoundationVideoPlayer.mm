...
//#import "ofxAVFoundationExtras.h"
...
ofAVFoundationVideoPlayer::ofAVFoundationVideoPlayer() {
	videoPlayer = NULL;
	pixelsRGB = NULL;
	pixelsRGBA = NULL;
...
//----------------------------------------
bool ofAVFoundationVideoPlayer::loadMovie(string name) {
...
//----------------------------------------
void ofAVFoundationVideoPlayer::close() {
	if(videoPlayer != NULL) {
...
//----------------------------------------
bool ofAVFoundationVideoPlayer::setPixelFormat(ofPixelFormat _internalPixelFormat) {
...
//---------------------------------------------------------------------------
ofPixelFormat ofAVFoundationVideoPlayer::getPixelFormat(){
	return internalPixelFormat;
}

//----------------------------------------
void ofAVFoundationVideoPlayer::update() {
...
//----------------------------------------
void ofAVFoundationVideoPlayer::play() {
    if(videoPlayer == NULL) {
        ofLog(OF_LOG_WARNING, "ofAVFoundationVideoPlayer::play() - video needs to be first loaded.");
    }
...
//----------------------------------------
void ofAVFoundationVideoPlayer::stop() {
    if(videoPlayer == NULL) {
        return;
    }
...
//----------------------------------------
bool ofAVFoundationVideoPlayer::isFrameNew() {
	if(videoPlayer != NULL) {
		return bFrameNew;
	}	
	return false;
...
//----------------------------------------
unsigned char * ofAVFoundationVideoPlayer::getPixels() {
...
void ofAVFoundationVideoPlayer::updatePixelsToRGB () {
...
//----------------------------------------
ofPixelsRef ofAVFoundationVideoPlayer::getPixelsRef() {
    static ofPixels dummy;
    return dummy;
}

//----------------------------------------
ofTexture * ofAVFoundationVideoPlayer::getTexture() {
...
#endif            
    {
        ...
        if([(AVFoundationVideoPlayer *)videoPlayer getWidth] > maxTextureSize || 
           [(AVFoundationVideoPlayer *)videoPlayer getHeight] > maxTextureSize) {
            ofLog(OF_LOG_WARNING, "ofAVFoundationVideoPlayer::getTexture() - video image is bigger then supported texture size");
            return NULL;
        }
...
//----------------------------------------
float ofAVFoundationVideoPlayer::getWidth() {
    if(videoPlayer == NULL) {
        return 0;
    }
...
//----------------------------------------
float ofAVFoundationVideoPlayer::getHeight() {
    if(videoPlayer == NULL) {
        return 0;
    }
...
//----------------------------------------
bool ofAVFoundationVideoPlayer::isPaused() {
    if(videoPlayer == NULL) {
        return false;
    }
...
//----------------------------------------
bool ofAVFoundationVideoPlayer::isLoaded() {
    if(videoPlayer == NULL) {
        return false;
    }
...
//----------------------------------------
bool ofAVFoundationVideoPlayer::isPlaying() {
    if(videoPlayer == NULL) {
        return false;
    }
...
//----------------------------------------
float ofAVFoundationVideoPlayer::getPosition() {
    if(videoPlayer == NULL) {
        return 0;
    }
...
//----------------------------------------
float ofAVFoundationVideoPlayer::getSpeed() {
    if(videoPlayer == NULL) {
        return 0;
    }
...
//----------------------------------------
float ofAVFoundationVideoPlayer::getDuration() {
    if(videoPlayer == NULL) {
        return 0;
    }
...
//----------------------------------------
bool ofAVFoundationVideoPlayer::getIsMovieDone() {
    if(videoPlayer == NULL) {
        return false;
    }
...
//----------------------------------------
void ofAVFoundationVideoPlayer::setPaused(bool bPause) {
    if(videoPlayer == NULL) {
        return;
    }
...
//----------------------------------------
void ofAVFoundationVideoPlayer::setPosition(float pct) {
    if(videoPlayer == NULL) {
        return;
    }
...
//----------------------------------------
void ofAVFoundationVideoPlayer::setVolume(float volume) {
    if(videoPlayer == NULL) {
        return;
    }
	if ( volume > 1.0f ){
		ofLogWarning("ofAVFoundationVideoPlayer") << "*** the range of setVolume changed with oF0072 from int [0..100] to float [0..1].";
		ofLogWarning("ofAVFoundationVideoPlayer") << "*** limiting input volume " << volume << " to 1.0f.";
		volume = 1.0f;
	}
...
//----------------------------------------
void ofAVFoundationVideoPlayer::setLoopState(ofLoopType state) {
    if(videoPlayer == NULL) {
        return;
    }
...
//----------------------------------------
void ofAVFoundationVideoPlayer::setSpeed(float speed) {
    if(videoPlayer == NULL) {
        return;
    }
...
//----------------------------------------
void ofAVFoundationVideoPlayer::setFrame(int frame) {
    if(videoPlayer == NULL) {
        return;
    }
...
//----------------------------------------
int	ofAVFoundationVideoPlayer::getCurrentFrame() {
    return -1; // not supported yet.
}

//----------------------------------------
int	ofAVFoundationVideoPlayer::getTotalNumFrames() {
    return -1; // not supported yet.
}

//----------------------------------------
ofLoopType	ofAVFoundationVideoPlayer::getLoopState() {
    if(videoPlayer == NULL) {
        return OF_LOOP_NONE;
    }
...
//----------------------------------------
void ofAVFoundationVideoPlayer::firstFrame() {
    if(videoPlayer == NULL) {
        return;
    }
...
//----------------------------------------
void ofAVFoundationVideoPlayer::nextFrame() {
    return; // not supported yet.
}

//----------------------------------------
void ofAVFoundationVideoPlayer::previousFrame() {
    return; // not supported yet.
}

//----------------------------------------
void * ofAVFoundationVideoPlayer::getAVFoundationVideoPlayer() {
    return videoPlayer;
}
